...
This version (v1.6) is permanently archived and retained only as a historical branch.

- No further feature updates, bug fixes, or security patches will be accepted.
- No technical support or issue responses will be provided.
- Anyone is free to use, modify, or commercialize this code under the MIT License, but the project team assumes no liability.

For the latest source code and actively maintained versions, please visit the main branch:
https://github.com/MoHong-MHO/MoDx/
...
本版本 (v1.6) 属于永久归档版本，仅作为历史分支保留。

- 不再接受任何功能更新、Bug 修复或安全补丁。
- 不再提供技术支持或问题响应。
- 任何人可基于 MIT 协议自由使用、修改、商用，项目方不承担任何责任。

如需获取最新源码和持续维护版本，请前往主分支：
https://github.com/MoHong-MHO/MoDx/